  ...
  return (
    <article className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
      ...
      <div className="flex flex-col items-center space-y-6 md:space-y-12">
        <img
          className="h-full max-h-[500px] w-full rounded-2xl object-cover object-center shadow-lg"
        ...
        <address className="flex flex-col items-center space-y-4 not-italic">
          <Logo className="text-foreground h-auto w-48 max-w-[90vw]" />
          ...
          <p className="text-base md:text-lg">
            <time>12:00 〜 20:00</time><span className="px-4">/</span>日・月<span className="pl-4">定休</span>
          </p>
