  ...
  return (
    <header className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className={`absolute bottom-8 left-1/2 z-10 -translate-x-1/2 ${styles.heroScrollEnter}`}>
        <div className="animate-bounce" aria-label="スクロールして続きを見る">
          <svg className="h-6 w-6 text-white drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
